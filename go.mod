...
replace securosys.ch/integration/client => ./integrationTests/client

replace securosys.ch/integration/tests => ./integrationTests/tests
...
require (
	...
	securosys.ch/client v0.0.0-00010101000000-000000000000 // indirect
	securosys.ch/helpers v0.0.0-00010101000000-000000000000 // indirect
)
